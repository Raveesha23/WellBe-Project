  ...
  <body>
    <header>
      <nav class="section__container nav__container">
        <div class="nav__logo"><img src="assets/images/logo (1).png"/>WELL BE</div>
    ...
    <section class="section__container doctors__container" id="pages">
      ...
      <div class="doctors__grid">
        ...
        <div class="doctors__card">
          <div class="doctors__card__image">
            <img src="assets/images/doctor-2.jpg" alt="doctor" />
            <div class="doctors__socials">
              <span><i class="ri-instagram-line"></i></span>
              <span><i class="ri-facebook-fill"></i></span>
              <span><i class="ri-heart-fill"></i></span>
        ...
        <div class="doctors__card">
          <div class="doctors__card__image">
            <img src="assets/images/doctor-3.jpg" alt="doctor" />
            <div class="doctors__socials">
              <span><i class="ri-instagram-line"></i></span>
              <span><i class="ri-facebook-fill"></i></span>
              <span><i class="ri-heart-fill"></i></span>
    ...
    <footer class="footer">
      <div class="section__container footer__container">
        <div class="footer__col">
          <div class="footer__logo"><img src="assets/images/logo (1).png"/></div>
          <p>
